...
export default class Storage {
   ...
   * @param expire
   */
  set(key: string, value: any, expire: number | null = CFG.DEFAULT_CACHE_TIME) {
   ...
   * @example
   */
  setCookie(name: string, value: any, expire?: number | null) {
  ...
  getAccessToken(): string {
    return this.getCookie(CFG.ACCESS_TOKEN);
  }
  getRefreshToken(): string {
    return this.getCookie(CFG.REFRESH_TOKEN);
  }
}
